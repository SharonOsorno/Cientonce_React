...
const Articulos = () => {
    ...
    return (
        <div className = "row">
            ...
            <div className="col-lg-4 col-md-6 mb-4">
                <div className="card h-100">
                    <a href="#"><img src={Chompa} alt="articulo2"/></a>
                    <div className="card-body">
                        <h4 className="card-title">
            ...
            <div className="col-lg-4 col-md-6 mb-4">
                <div className="card h-100">
                    <a href="#"><img src={BlackTshirt} alt="articulo3"/></a>
                    <div className="card-body">
                        <h4 className="card-title">
            ...
            <div className="col-lg-4 col-md-6 mb-4">
                <div className="card h-100">
                    <a href="#"><img src={WhiteTshirt} alt="articulo4"/></a>
                    <div className="card-body">
                        <h4 className="card-title">
                            <a className="article-tittle text-bold" href="#">T-shirt Nuevo Formato</a>
                        </h4>
            ...
            <div className="col-lg-4 col-md-6 mb-4">
                <div className="card h-100">
                    <a href="#"><img src={Totebag} alt="articulo5"/></a>
                    <div className="card-body">
                        <h4 className="card-title">
            ...
            <div className="col-lg-4 col-md-6 mb-4">
                <div className="card h-100">
                    <a href="#"><img src={Gorra} alt="articulo6"/></a>
                    <div className="card-body">
                        <h4 className="card-title">
